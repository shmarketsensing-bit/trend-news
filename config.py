...
CATEGORY_KEYWORDS = {
    ...
    "라이프스타일": ["잘파세대 트렌드", "시니어 트렌드", "라이프스타일 소비 트렌드", "1인가구 트렌드"],
...
PRIORITY_PRESS_ALIASES = {
    ...
    "매일경제": ["매일경제", "mk.co.kr"],
    "전자신문": ["전자신문", "etnews.com"],
    "ZDNet Korea": ["ZDNet Korea", "zdnet.co.kr", "zdnet"],
    "아주경제": ["아주경제", "ajunews.com"],
    "이데일리": ["이데일리", "edaily.co.kr"],
    "헤럴드경제": ["헤럴드경제", "heraldcorp.com", "herald경제"],
    "뉴시스": ["뉴시스", "newsis.com"],
    "연합뉴스": ["연합뉴스", "yna.co.kr"],
    "비즈워치": ["비즈워치", "bizwatch.co.kr"],
}
