...
TREND_SIGNAL_KEYWORDS = [
    ...
    "급부상", "부상", "확산", "확산세", "확대", "성장",
    "증가", "가속화", "본격화", "주목", "대세", "인기",
    "유행", "트렌드", "뜨다", "뜬다", "뜨는", "떠오르다",
    "역주행", "완판", "품절", "오픈런", "속속", "잇따라","소비층"
]
...
NOISE_KEYWORDS = [
    ...
    "승리", "패배", "골", "득점",
    "학과장", "인터뷰", "간담회", "강연", "애널리스트 리포트", "베스트 애널리스트",
    "합작 투자", "재무부담", "실적 발표", "자산 승계", "분쟁", "규제 완화",
]
